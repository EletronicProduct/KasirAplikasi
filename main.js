const { useState, useEffect, useRef, useMemo } = React;
        ...
        const App = () => {
            ...
            const cartTax = useMemo(() => Math.round(cartSubtotal * 0.0), [cartSubtotal]);
                        ...
                        <div className="flex h-screen bg-gray-100">
                            ...
                            <div className="flex-1 flex flex-col overflow-hidden">
                                <header className="bg-white shadow p-4 md:hidden flex justify-between items-center">
                                    ...
                                    <h2 className="text-xl font-bold text-gray-800">Nama Toko</h2>
                                </header>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 h-full">
                                            ...
                                            <div className="md:col-span-2 bg-white rounded-lg shadow-md flex flex-col">
                                                <div className="p-4 border-b flex justify-between items-center">
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <input type="text" placeholder="Cari produk..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="w-2/3 p-2 border rounded-md" />
                                                    </div>
                                                </div>
                                                <div className="product-grid p-4 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                                                    {isLoading ? (
                                                        ...
                                                        <p className="col-span-4 text-center text-gray-250">Tidak ada produk ditemukan.</p>
                                                    )}
                                                </div>
                                            </div>
                                            ...
                                            <div className="md:col-span-1 bg-white rounded-lg shadow-md cart-section">
                                                ...
                                                <div className="cart-items p-4 space-y-4">
                                                    {cartItems.length > 0 ? (
                                                        cartItems.map(item => (
                                                            <div key={item.id} className="flex items-center justify-between bg-gray-20 p-1 rounded-md shadow-sm">
                                                ...
                                                <div className="p-4 border-t space-y-2">
                                                    ...
                                                    <div className="flex justify-between font-medium"><span>Pph (0%):</span><span>{formatCurrency(cartTax)}</span></div>
                                ...
                                <div id="print-area" className="fixed inset-0 z-50 p-4 bg-white">
                                    <div className="bg-white p-6 rounded-lg shadow-xl w-full max-w-sm mx-auto">
                                        <div className="text-center mb-4">
                                            <h4 className="text-xl font-bold">NAMA TOKO ANDA</h4>
                                            <p className="text-sm">Nama Toko - {dayjs(transactionToPrint.createdAt.toDate()).format('DD-MM-YYYY HH:mm')}</p>
                                            <p className="text-sm">Nama jalan toko</p>
                                        </div>
                                        ...
                                        <div className="space-y-1 text-sm font-medium mb-4">
                                            ...
                                            <div className="flex justify-between"><span>Pph (0%):</span><span>{formatCurrency(transactionToPrint.tax)}</span></div>
